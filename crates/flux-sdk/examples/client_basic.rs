//! The agentic front door: [`flux_sdk::Client`] wraps the adaptive Flux-Lang outer loop, the safety
//! envelope, and a session. Here a hermetic mock provider answers the typed stages so the example
