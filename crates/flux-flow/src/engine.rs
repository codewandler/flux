...
"#,
    ...
    fn base_system_carries_a_worktree_note_only_while_transitioned() {
        ...
        let mut sink = CollectSink::default();
        let before = engine.base_system_with_skills("hello", &mut sink);
        assert!(
        ...
        let during = engine.base_system_with_skills("hello", &mut sink);
        ...
        engine
            ...
            .leave_worktree()
            .unwrap();
        let after = engine.base_system_with_skills("hello", &mut sink);
        assert!(
