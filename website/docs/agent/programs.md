...
[language overview](../language/overview.md) and [text syntax](../language/text-syntax.md).
...
- [Language overview](../language/overview.md) and [text syntax](../language/text-syntax.md) — the Flux-Lang you write journey bodies in.
