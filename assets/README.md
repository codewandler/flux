...
| --- | --- | --- | --- | --- |
| <img src="flux-logo.png" alt="flux-logo" width="180"> | `flux-logo.svg` / `flux-logo.png` | vector / 1094×426 | Transparent | **Primary logo / README hero.** Horizontal lockup: flow mark + "Flux / flux-flow" wordmark. Edit the `.svg` and re-render the `.png` (`rsvg-convert -h 500 flux-logo.svg \| magick - -trim +repage -bordercolor none -border 28 flux-logo.png`). |
