...
### Context-local Git worktrees (epic) — ✅ **IMPLEMENTED 2026-07-28 (C-97…C-100, unreleased; awaiting merge from the epic worktree branch; next MINOR — `ToolContext.system` field → accessor is breaking)**
