...
- [ ] Targeted `flux-tools` tests pass on the integrated main tree.

## Progress

- 2026-08-05: Contract recovered during local-main integration after the implementation had landed
  in a bundled local commit. The code and documentation already satisfy the functional acceptance;
  the integrated-tree targeted test remains before closure.
